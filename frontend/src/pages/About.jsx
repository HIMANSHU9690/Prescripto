...
const About = () => {
  return (
    ...
    <div className='my-10 flex flex-co md:flex-row gap-12'>
     ...
     <div className='text-xl my-4 '>
       ...
       <div className=' flex felx-col md:flex-row mb-20'>
        ...
        <div className='border px-10 md:px-16 py-8 sm:py-16 flex flex-col gap- text-[15px] hover:bg-primary hover:text-white transition-all duration-300 text-gray cursor-pointer' >
       <b>Efficiency:</b>
